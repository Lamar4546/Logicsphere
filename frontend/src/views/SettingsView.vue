...
const themes = [
  ...
  { id: 'obsidian', name: 'Obsidian', description: 'A true dark high-contrast theme for command-center work.' },
...
<style scoped>
.settings{max-width:950px}.settings header{margin-bottom:1.5rem}.settings header .mono{font-size:.66rem;letter-spacing:.1em}.settings h2{font-size:1.45rem;margin:.25rem 0}.settings header p,.section p{color:var(--text-dim);font-size:.86rem;line-height:1.5}.section{display:grid;grid-template-columns:.85fr 1.15fr;gap:2rem;padding:1.35rem;margin-bottom:1rem}.section h3{font-size:1rem}.section p{margin:.4rem 0}.themes{display:grid;grid-template-columns:repeat(2,1fr);gap:.7rem}.theme-card{position:relative;display:flex;flex-direction:column;align-items:flex-start;gap:.45rem;padding:.75rem;border:1px solid var(--line);text-align:left}.theme-card.selected{border:2px solid var(--signal);background:var(--panel-2)}.theme-card small{color:var(--text-dim);font-size:.7rem;line-height:1.4}.theme-card b{font-size:.65rem;color:var(--signal)}.swatches{display:flex;gap:.2rem}.swatches i{width:1rem;height:1rem;border-radius:50%;background:#257fc8}.swatches i:nth-child(2){background:#edf5fd}.swatches i:nth-child(3){background:#163d63}.midnight .swatches i{background:#2d8ddd}.midnight .swatches i:nth-child(2){background:#172333}.midnight .swatches i:nth-child(3){background:#d8e8fa}.obsidian .swatches i{background:#51b5ff}.obsidian .swatches i:nth-child(2){background:#0d1520}.obsidian .swatches i:nth-child(3){background:#f2f7fb}.slate .swatches i{background:#547a93}.slate .swatches i:nth-child(2){background:#eef2f4}.slate .swatches i:nth-child(3){background:#253a4a}.profile-form{display:flex;flex-direction:column;gap:.7rem}.profile-form label{display:flex;flex-direction:column;gap:.35rem;font-size:.78rem}.profile-form button{align-self:flex-start}.saved{color:var(--risk-low)}.account-info{display:grid;grid-template-columns:1fr 1fr;gap:.65rem;font-size:.8rem}.account-info span{color:var(--text-dim)}.danger-zone{border-color:color-mix(in srgb,var(--risk-critical) 45%,var(--line))}.danger-zone h3{color:var(--risk-critical)}.danger-zone form{display:flex;align-items:end;gap:.65rem;flex-wrap:wrap}.danger-zone label{display:flex;flex-direction:column;gap:.35rem;font-size:.78rem}.danger-zone input{width:150px}.delete{background:var(--risk-critical);color:#fff;border-color:var(--risk-critical)}.delete:disabled{opacity:.5}.error{width:100%;margin:0!important;color:var(--risk-critical)!important}@media(max-width:700px){.section{grid-template-columns:1fr;gap:1rem}.themes{grid-template-columns:1fr}.account-info{grid-template-columns:1fr}.danger-zone form{align-items:stretch}.danger-zone input{width:100%}}
</style>
